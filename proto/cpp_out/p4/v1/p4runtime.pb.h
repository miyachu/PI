...
class TableEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p4.v1.TableEntry) */ {
 public:
  ...
  void clear_controller_metadata();
  static const int kControllerMetadataFieldNumber = 5;
  ::google::protobuf::uint64 controller_metadata() const;
  void set_controller_metadata(::google::protobuf::uint64 value);
