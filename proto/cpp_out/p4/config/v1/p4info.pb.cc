...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 24, -1, sizeof(PkgInfo)},
  { 36, -1, sizeof(P4Ids)},
  { 40, -1, sizeof(Preamble)},
  { 49, -1, sizeof(Extern)},
  { 56, -1, sizeof(ExternInstance)},
  { 62, -1, sizeof(MatchField)},
  { 75, -1, sizeof(Table)},
  { 89, -1, sizeof(ActionRef)},
  { 96, -1, sizeof(Action_Param)},
  { 106, -1, sizeof(Action)},
  { 112, -1, sizeof(ActionProfile)},
  { 121, -1, sizeof(CounterSpec)},
  { 126, -1, sizeof(Counter)},
  { 134, -1, sizeof(DirectCounter)},
  { 141, -1, sizeof(MeterSpec)},
  { 146, -1, sizeof(Meter)},
  { 154, -1, sizeof(DirectMeter)},
  { 161, -1, sizeof(ControllerPacketMetadata_Metadata)},
  { 169, -1, sizeof(ControllerPacketMetadata)},
  { 175, -1, sizeof(ValueSet)},
  { 182, -1, sizeof(Register)},
  { 190, -1, sizeof(Digest)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "\013\n\003url\030\010 \001(\t\"\207\002\n\005P4Ids\"\375\001\n\006Prefix\022\017\n\013UNS"
      "PECIFIED\020\000\022\n\n\006ACTION\020\001\022\t\n\005TABLE\020\002\022\r\n\tVAL"
      "UE_SET\020\003\022\025\n\021CONTROLLER_HEADER\020\004\022\025\n\021PSA_E"
      "XTERNS_START\020\020\022\022\n\016ACTION_PROFILE\020\021\022\013\n\007CO"
      "UNTER\020\022\022\022\n\016DIRECT_COUNTER\020\023\022\t\n\005METER\020\024\022\020"
      "\n\014DIRECT_METER\020\025\022\014\n\010REGISTER\020\026\022\n\n\006DIGEST"
      "\020\027\022\030\n\023OTHER_EXTERNS_START\020\200\001\022\010\n\003MAX\020\377\001\"r"
      "\n\010Preamble\022\n\n\002id\030\001 \001(\r\022\014\n\004name\030\002 \001(\t\022\r\n\005"
      "alias\030\003 \001(\t\022\023\n\013annotations\030\004 \003(\t\022(\n\003doc\030"
      "\005 \001(\0132\033.p4.config.v1.Documentation\"k\n\006Ex"
      "tern\022\026\n\016extern_type_id\030\001 \001(\r\022\030\n\020extern_t"
      "ype_name\030\002 \001(\t\022/\n\tinstances\030\003 \003(\0132\034.p4.c"
      "onfig.v1.ExternInstance\"^\n\016ExternInstanc"
      "e\022(\n\010preamble\030\001 \001(\0132\026.p4.config.v1.Pream"
      "ble\022\"\n\004info\030\002 \001(\0132\024.google.protobuf.Any\""
      "\316\002\n\nMatchField\022\n\n\002id\030\001 \001(\r\022\014\n\004name\030\002 \001(\t"
      "\022\023\n\013annotations\030\003 \003(\t\022\020\n\010bitwidth\030\004 \001(\005\022"
      "8\n\nmatch_type\030\005 \001(\0162\".p4.config.v1.Match"
      "Field.MatchTypeH\000\022\032\n\020other_match_type\030\007 "
      "\001(\tH\000\022(\n\003doc\030\006 \001(\0132\033.p4.config.v1.Docume"
      "ntation\022,\n\ttype_name\030\010 \001(\0132\031.p4.config.v"
      "1.P4NamedType\"H\n\tMatchType\022\017\n\013UNSPECIFIE"
      "D\020\000\022\t\n\005EXACT\020\002\022\007\n\003LPM\020\003\022\013\n\007TERNARY\020\004\022\t\n\005"
      "RANGE\020\005B\007\n\005match\"\301\003\n\005Table\022(\n\010preamble\030\001"
      " \001(\0132\026.p4.config.v1.Preamble\022.\n\014match_fi"
      "elds\030\002 \003(\0132\030.p4.config.v1.MatchField\022,\n\013"
      "action_refs\030\003 \003(\0132\027.p4.config.v1.ActionR"
      "ef\022\037\n\027const_default_action_id\030\004 \001(\r\022\031\n\021i"
      "mplementation_id\030\006 \001(\r\022\033\n\023direct_resourc"
      "e_ids\030\007 \003(\r\022\014\n\004size\030\010 \001(\003\022F\n\025idle_timeou"
      "t_behavior\030\t \001(\0162\'.p4.config.v1.Table.Id"
      "leTimeoutBehavior\022\026\n\016is_const_table\030\n \001("
      "\010\022.\n\020other_properties\030d \001(\0132\024.google.pro"
      "tobuf.Any\"9\n\023IdleTimeoutBehavior\022\016\n\nNO_T"
      "IMEOUT\020\000\022\022\n\016NOTIFY_CONTROL\020\001\"\234\001\n\tActionR"
      "ef\022\n\n\002id\030\001 \001(\r\022,\n\005scope\030\003 \001(\0162\035.p4.confi"
      "g.v1.ActionRef.Scope\022\023\n\013annotations\030\002 \003("
      "\t\"@\n\005Scope\022\025\n\021TABLE_AND_DEFAULT\020\000\022\016\n\nTAB"
      "LE_ONLY\020\001\022\020\n\014DEFAULT_ONLY\020\002\"\201\002\n\006Action\022("
      "\n\010preamble\030\001 \001(\0132\026.p4.config.v1.Preamble"
      "\022*\n\006params\030\002 \003(\0132\032.p4.config.v1.Action.P"
      "aram\032\240\001\n\005Param\022\n\n\002id\030\001 \001(\r\022\014\n\004name\030\002 \001(\t"
      "\022\023\n\013annotations\030\003 \003(\t\022\020\n\010bitwidth\030\004 \001(\005\022"
      "(\n\003doc\030\005 \001(\0132\033.p4.config.v1.Documentatio"
      "n\022,\n\ttype_name\030\006 \001(\0132\031.p4.config.v1.P4Na"
      "medType\"\211\001\n\rActionProfile\022(\n\010preamble\030\001 "
      "\001(\0132\026.p4.config.v1.Preamble\022\021\n\ttable_ids"
      "\030\002 \003(\r\022\025\n\rwith_selector\030\003 \001(\010\022\014\n\004size\030\004 "
      "\001(\003\022\026\n\016max_group_size\030\005 \001(\005\"v\n\013CounterSp"
      "ec\022,\n\004unit\030\001 \001(\0162\036.p4.config.v1.CounterS"
      "pec.Unit\"9\n\004Unit\022\017\n\013UNSPECIFIED\020\000\022\t\n\005BYT"
      "ES\020\001\022\013\n\007PACKETS\020\002\022\010\n\004BOTH\020\003\"\236\001\n\007Counter\022"
      "(\n\010preamble\030\001 \001(\0132\026.p4.config.v1.Preambl"
      "e\022\'\n\004spec\030\002 \001(\0132\031.p4.config.v1.CounterSp"
      "ec\022\014\n\004size\030\003 \001(\003\0222\n\017index_type_name\030\004 \001("
      "\0132\031.p4.config.v1.P4NamedType\"{\n\rDirectCo"
      "unter\022(\n\010preamble\030\001 \001(\0132\026.p4.config.v1.P"
      "reamble\022\'\n\004spec\030\002 \001(\0132\031.p4.config.v1.Cou"
      "nterSpec\022\027\n\017direct_table_id\030\003 \001(\r\"h\n\tMet"
      "erSpec\022*\n\004unit\030\001 \001(\0162\034.p4.config.v1.Mete"
      "rSpec.Unit\"/\n\004Unit\022\017\n\013UNSPECIFIED\020\000\022\t\n\005B"
      "YTES\020\001\022\013\n\007PACKETS\020\002\"\232\001\n\005Meter\022(\n\010preambl"
      "e\030\001 \001(\0132\026.p4.config.v1.Preamble\022%\n\004spec\030"
      "\002 \001(\0132\027.p4.config.v1.MeterSpec\022\014\n\004size\030\003"
      " \001(\003\0222\n\017index_type_name\030\004 \001(\0132\031.p4.confi"
      "g.v1.P4NamedType\"w\n\013DirectMeter\022(\n\010pream"
      "ble\030\001 \001(\0132\026.p4.config.v1.Preamble\022%\n\004spe"
      "c\030\002 \001(\0132\027.p4.config.v1.MeterSpec\022\027\n\017dire"
      "ct_table_id\030\003 \001(\r\"\324\001\n\030ControllerPacketMe"
      "tadata\022(\n\010preamble\030\001 \001(\0132\026.p4.config.v1."
      "Preamble\022A\n\010metadata\030\002 \003(\0132/.p4.config.v"
      "1.ControllerPacketMetadata.Metadata\032K\n\010M"
      "etadata\022\n\n\002id\030\001 \001(\r\022\014\n\004name\030\002 \001(\t\022\023\n\013ann"
      "otations\030\003 \003(\t\022\020\n\010bitwidth\030\004 \001(\005\"k\n\010Valu"
      "eSet\022(\n\010preamble\030\001 \001(\0132\026.p4.config.v1.Pr"
      "eamble\022\'\n\005match\030\002 \003(\0132\030.p4.config.v1.Mat"
      "chField\022\014\n\004size\030\003 \001(\005\"\247\001\n\010Register\022(\n\010pr"
      "eamble\030\001 \001(\0132\026.p4.config.v1.Preamble\022/\n\t"
      "type_spec\030\002 \001(\0132\034.p4.config.v1.P4DataTyp"
      "eSpec\022\014\n\004size\030\003 \001(\005\0222\n\017index_type_name\030\004"
      " \001(\0132\031.p4.config.v1.P4NamedType\"c\n\006Diges"
      "t\022(\n\010preamble\030\001 \001(\0132\026.p4.config.v1.Pream"
      "ble\022/\n\ttype_spec\030\002 \001(\0132\034.p4.config.v1.P4"
      "DataTypeSpecb\006proto3"
  };
