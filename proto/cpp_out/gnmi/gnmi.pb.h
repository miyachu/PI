...
#ifndef PROTOBUF_gnmi_2fgnmi_2eproto__INCLUDED
#define PROTOBUF_gnmi_2fgnmi_2eproto__INCLUDED
...
class PathElem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gnmi.PathElem) */ {
 public:
  ...
  inline PathElem* New() const PROTOBUF_FINAL { return New(NULL); }

  PathElem* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
#endif  // PROTOBUF_gnmi_2fgnmi_2eproto__INCLUDED
